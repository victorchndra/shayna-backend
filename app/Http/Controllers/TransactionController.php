...
class TransactionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = Transaction::findOrFail($id); //cari data berdasarkan id yg ada di url
        $item->update($data);
    ...
    {
        // request status ini diambil dari url(get), yang telah di set di masing-masing tombolnya
        $request->validate([
